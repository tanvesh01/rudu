/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/remote-review/worker-configuration.d.ts --config cloudflare/remote-review/wrangler.jsonc` (hash: 57485e45db928d3ac49aa0bb5562bd75)
// Runtime types generated with workerd@1.20260511.1 2026-05-14
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RemoteReviewSessionObject";
	}
	interface Env {
		REMOTE_REVIEW_SESSIONS: DurableObjectNamespace<import("./src/index").RemoteReviewSessionObject>;
	}
}
