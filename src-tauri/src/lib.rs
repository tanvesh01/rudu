...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::model_provider_assets::read_model_provider_catalog_cache,
            commands::model_provider_assets::write_model_provider_catalog_cache,
            commands::model_provider_assets::read_model_provider_logo_cache,
            commands::model_provider_assets::write_model_provider_logo_cache,
            ...
            commands::review_session::run_review_walkthrough_turn,
            ...
            commands::review_session::complete_review_chat_turn,
