...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote_review::prepare_remote_review_session,
            commands::remote_review::hydrate_remote_review_session,
            commands::remote_review::start_remote_review_agent,
            commands::remote_review::ensure_remote_review_chat_session,
            commands::remote_review::send_remote_review_chat_message,
            commands::remote_review::cancel_remote_review_chat_turn,
            commands::remote_review::launch_pi_review_terminal,
            commands::remote_review::get_remote_review_report,
            commands::remote_review::get_remote_review_worker_config,
            commands::remote_review::save_remote_review_worker_config,
            commands::remote_review::pair_remote_review_worker_config,
            commands::remote_review::clear_remote_review_worker_config,
            commands::remote_review::test_remote_review_worker_config,
