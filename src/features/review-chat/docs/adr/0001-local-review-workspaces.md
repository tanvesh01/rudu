...
The Review Workspace itself is the review context. Rudu does not keep separate pull request diff snapshot files for the agent or app once the local worktree is available.
